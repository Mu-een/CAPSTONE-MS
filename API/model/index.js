...
class User {
    login(req, res) {
        ...
        const strQry = 
        `
        SELECT firstName, lastName, userRole, gender, emailAddress, userPassword, userProfile
        FROM users
    ...
    fetchUsers(req, res) {
        const strQry = 
        `
        SELECT userId, firstName, lastName, userRole, gender, emailAddress, userPassword, userProfile
        FROM users;
        `;
        //db
